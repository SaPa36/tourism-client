        ...
        <section className="py-20 bg-[#0B0F19]">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-black text-white mb-4">Traveler <span className="text-fuchsia-500">Stories</span></h2>
                    <p className="text-gray-400">Hear from our community of world explorers</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {reviews.map((rev) => (
                        <div key={rev.id} className="bg-white/5 border border-white/10 p-8 rounded-[2rem] hover:bg-white/10 transition-all duration-300 relative group">
